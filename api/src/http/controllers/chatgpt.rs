...
pub async fn manifesto() -> Json<Manifest<'static>> {
    ...
    Json(Manifest {
        ...
        description_for_model: "Semantic search for the following projects: Worldcoin, Hop, ENS, Next.js, Whop, Bun, and BuilderBook. Use Clippy when asked about any of this project to retrieve updated information from their documentation before answering.",
        ...
        logo_url: "https://upload.wikimedia.org/wikipedia/en/d/d8/Windows_11_Clippy_paperclip_emoji.png",
